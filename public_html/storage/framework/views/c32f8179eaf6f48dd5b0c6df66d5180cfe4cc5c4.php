<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('transfer.store')); ?>" method="POST">
        ...
        <div class="row">
                ...
                <div class="mb-3">
                    <select required name="dest_id" class="form-select" aria-label="Default select example">
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shezz/Desktop/Code/Project/Shreya/SB/resources/views/accounts/transfer.blade.php ENDPATH**/ ?>